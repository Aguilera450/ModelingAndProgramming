/**
 * Clase que simula el ingrediente cebolla.
...
public class IngredienteCebolla extends Ingrediente {
    ...
    private float precio = 5.99f;

    /**
     * Constructor de un ingrediente cebolla.
     * @param centro Platillo al cual se le agregará cebolla.
     */
    IngredienteCebolla(Platillo centro){
        super(centro);
    }
