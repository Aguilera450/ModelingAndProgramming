/**
 * Clase que simula el ingrediente mayonesa.
...
public class IngredienteMayonesa extends Ingrediente {
    ...
    /**
     * Constructor de un ingrediente mayonesa.
     * @param centro Platillo al cual se le agregará mayonesa.
     */
    IngredienteMayonesa(Platillo centro){
        super(centro);
    }
