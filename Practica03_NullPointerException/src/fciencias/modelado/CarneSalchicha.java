/**
 * Clase Carne Salchicha implementada a partir de la
 * interfaz Carne.
 ...
 */
public class CarneSalchicha implements Carne{
    ...
    /**
     * Constructor de la clase CarneSalchicha.
     * Establece el nombre y el precio.
     */
    public CarneSalchicha(){
        nombre = "Salchicha";
        precio = 20.20f;
    }
