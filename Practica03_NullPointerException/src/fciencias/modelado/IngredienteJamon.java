/**
 * Clase que simula el ingrediente jamon.
...
public class IngredienteJamon extends Ingrediente {
    ...
    private float precio = 8.99f;

    /**
     * Constructor de un ingrediente jamon.
     * @param centro Platillo al cual se le agregará jamon.
     */
    IngredienteJamon(Platillo centro){
        super(centro);
    }
